...
from ventis.cli import DEFAULT_CONFIG_PATH
...
def build():
    ...
    # return its combined output. cwd is the workspace, one level above `.car`,
    # so generated stubs/, grpc_stubs/ and docker_container/ land under it.
